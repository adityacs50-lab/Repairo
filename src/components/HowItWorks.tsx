    ...
    <section className="w-full py-16 px-6 md:px-12 max-w-7xl mx-auto border-t border-neutral-200">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col justify-between">
          ...
          {/* Graphic Box */}
          <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-4 flex items-center justify-center gap-3 hover:border-neutral-300 transition-colors">
        ...
        <motion.div variants={itemVariants} className="flex flex-col justify-between">
          ...
          {/* Graphic Box */}
          <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-3.5 space-y-1.5 text-xs hover:border-neutral-300 transition-colors">
        ...
        <motion.div variants={itemVariants} className="flex flex-col justify-between">
          ...
          {/* Graphic Box */}
          <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-4 flex gap-3 items-center justify-center hover:border-neutral-300 transition-colors">
        ...
        <motion.div variants={itemVariants} className="flex flex-col justify-between">
          ...
          {/* Graphic Box */}
          <div className="bg-white border border-neutral-200 rounded-xl p-4 flex items-center justify-between shadow-2xs hover:border-neutral-300 transition-colors">
